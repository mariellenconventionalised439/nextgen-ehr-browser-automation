/**
 * basic-login.js — Basic login example for NextGen EHR
...
async function main() {
  ...
  try {
    log('Starting NextGen EHR automation (Open Source mode)');
    ...
    const result = await login_nextgen(page, {
    ...
    // const data = await schedule_patient(page, {});
    // log('Data:', data);
